  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full px-6 md:px-10 grid lg:grid-cols-2 gap-16 items-center pt-28 pb-20">
        {/* Copy */}
        <div>
          <p className="hero-eyebrow eyebrow mb-6">The 2026 Collection — No. VII</p>
          <h1 className="font-display font-light leading-[0.95] text-[13vw] sm:text-6xl md:text-7xl lg:text-[5.2rem]">
            <span className="hero-line block overflow-hidden">Scent is the</span>
            <span className="hero-line block overflow-hidden text-gold-sheen italic">only memory</span>
            <span className="hero-line block overflow-hidden">that never fades.</span>
          </h1>
          <p className="hero-sub mt-8 max-w-md text-ivory/65 text-base leading-relaxed">
            Hand-composed in small batches from rare oud, orris root, and
            centuries-old distillation houses — L'Or Noir is worn, not sprayed.
          </p>
          ...
          {heroImage ? (
            ...
            >
              ...
              <path
                ...
                opacity="0.85"
              />
              <rect x="55" y="150" width="90" height="60" fill="#0A0908" opacity="0.35" />
            </svg>
          )}
        </div>
      </div>
