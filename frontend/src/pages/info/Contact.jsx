    ...
    <div className="pt-32 pb-24 max-w-6xl mx-auto px-6 md:px-10">
      ...
      <div className="grid lg:grid-cols-[1fr_360px] gap-14">
        ...
        <Reveal delay={0.15} className="space-y-6">
          <ContactRow icon={HiOutlineMail} label="Email" value="hello@lornoir.com" />
          <ContactRow icon={HiOutlinePhone} label="Phone" value="+1 (415) 555-0142" />
          <ContactRow icon={HiOutlineLocationMarker} label="Atelier" value="24 Rue de la Paix, Paris" />
        </Reveal>
      </div>
    </div>
  );
